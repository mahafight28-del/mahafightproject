        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    assigned_dealer_id = table.Column<Guid>(type: "uuid", nullable: true),
                    total_amount = table.Column<decimal>(type: "numeric(12,2)", precision: 12, scale: 2, nullable: false),
                    status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "Pending"),
                    payment_method = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "COD"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_orders_dealers_assigned_dealer_id",
                        column: x => x.assigned_dealer_id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_orders_assigned_dealer_id",
                table: "orders",
                column: "assigned_dealer_id");
